...
class OutlookServicesMethodsImpl {
    ...
    void tentativelyAccept(final CallbackContext context, final OutlookClient client, final DefaultDependencyResolver resolver, final ODataMethodArgs methodArgs) {
    ...
    void decline(final CallbackContext context, final OutlookClient client, final DefaultDependencyResolver resolver, final ODataMethodArgs methodArgs) {
